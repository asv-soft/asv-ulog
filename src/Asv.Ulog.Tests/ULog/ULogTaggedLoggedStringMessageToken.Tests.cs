...
public class ULogTaggedLoggedStringMessageTokenTests
{
    ...
    [InlineData(
        ULogTaggedLoggedStringMessageToken.ULogLevel.Debug,
        42,
        987654321UL,
        "Another test"
    )]
    [InlineData(
        ULogTaggedLoggedStringMessageToken.ULogLevel.Info,
        65535,
        1234567890UL,
        "Debug info"
    )]
    public void DeserializeToken_Success(
        ULogTaggedLoggedStringMessageToken.ULogLevel logLevel,
        ushort tag,
        ulong timestamp,
        string message
    )
    ...
    private static ULogTaggedLoggedStringMessageToken SetUpTestToken(
        ULogTaggedLoggedStringMessageToken.ULogLevel logLevel,
        ushort tag,
        ulong timestamp,
        string message
