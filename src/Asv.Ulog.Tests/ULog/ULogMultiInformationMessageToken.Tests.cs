...
public class ULogMultiInformationMessageTokenTests
{
    private readonly ITestOutputHelper _output;

    public ULogMultiInformationMessageTokenTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public void Multi_DeserializeToken_Success(byte isContinued, string type, string name, ValueType value)
    {
        ...
        Assert.Equal(value, ULog.ULog.GetSimpleValue(token.Key.Type.BaseType, token.Value));
    }
