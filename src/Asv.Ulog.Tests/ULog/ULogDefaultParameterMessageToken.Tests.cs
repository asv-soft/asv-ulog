...
public class ULogDefaultParameterMessageTokenTests
{
    ...
    public void DeserializeToken_WrongDefaultType(
        byte defaultType,
        string type,
        string name,
        ValueType value
    ...
    public void DeserializeToken_WrongULogType(
        byte defaultType,
        string type,
        string name,
        ValueType value
    ...
    public void DeserializeToken_WrongKeyName(
        byte defaultType,
        string type,
        string name,
        ValueType value
    ...
    public void DeserializeToken_WrongKeyBytes(
        byte defaultType,
        string type,
        string name,
        ValueType value
    ...
    [Theory]
    [InlineData(
        ULogParameterDefaultTypes.SystemWide,
        ULogTypeDefinition.FloatTypeName,
        "data",
        float.MaxValue
    )]
    [InlineData(
    ...
    [InlineData(
        ULogParameterDefaultTypes.SystemWide,
        ULogTypeDefinition.Int32TypeName,
        "data",
        Int32.MaxValue
    )]
    [InlineData(
    ...
    [InlineData(
        ULogParameterDefaultTypes.SystemWide | ULogParameterDefaultTypes.ForCurrentConfiguration,
        ULogTypeDefinition.Int32TypeName,
        "data",
        0
    )]
    [InlineData(
        ULogParameterDefaultTypes.ForCurrentConfiguration,
        ULogTypeDefinition.Int32TypeName,
        "data",
        0
    )]
    public void SerializeToken_Success(
        ULogParameterDefaultTypes defaultType,
        string type,
        string name,
        ValueType value
    )
    ...
    public void SerializeToken_WrongValue(
        ULogParameterDefaultTypes defaultType,
        string type,
        string name,
        ValueType value
    ...
    public void SerializeToken_WrongDefaultType(
        ULogParameterDefaultTypes defaultType,
        string type,
        string name,
        ValueType value
    ...
    private ULogDefaultParameterMessageToken SetUpTestToken(
        ULogParameterDefaultTypes defaultType,
        string type,
        string name,
        ValueType value
    ...
    )
    {
        ...
        var buffer = new Span<byte>(
            new byte[2 + ULog.ULog.Encoding.GetByteCount(key) + valueBytes.Length]
        );
