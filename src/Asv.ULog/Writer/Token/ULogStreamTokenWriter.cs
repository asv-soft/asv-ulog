...
public class ULogStreamTokenWriter : ULogTokenWriter
{
    private readonly Stream _stream;

    public ULogStreamTokenWriter(Stream stream, string sourceName, int? writeSyncTokenEveryXToken = null, bool leaveOpen = false) 
        : base(sourceName, writeSyncTokenEveryXToken, leaveOpen ? null : stream)
    {
